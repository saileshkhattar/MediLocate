...
function UserHome() {
  const categories = [
    { name: "Medicines", icon: <LocalPharmacyIcon />, color: "#667eea", count: "500+" },
    { name: "Supplements", icon: <MedicationIcon />, color: "#f093fb", count: "200+" },
    { name: "Vaccines", icon: <VaccinesIcon />, color: "#4facfe", count: "50+" },
    { name: "Health Care", icon: <HealthAndSafetyIcon />, color: "#43e97b", count: "150+" },
  ];
  ...
  const steps = [
    { number: "1", title: "Search Medicine", description: "Find the medicine you need" },
    { number: "2", title: "Add to Cart", description: "Add items to your cart" },
    { number: "3", title: "Place Order", description: "Complete your purchase" },
    { number: "4", title: "Get Delivered", description: "Receive at your doorstep" },
  ];
    ...
    <>
      ...
      >
        <Container maxWidth="lg">
          <Box textAlign="center" position="relative" zIndex={1}>
            ...
            >
              Your trusted partner for all medical needs - medicines, supplements, and healthcare essentials
            </Typography>
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment position="start">
                      <SearchIcon sx={{ color: '#667eea', ml: 1, fontSize: '1.5rem' }} />
                    </InputAdornment>
                  ),
                }}
              />
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box textAlign="center" mb={6}>
          ...
          <Typography variant="h6" color="text.secondary" maxWidth="600px" mx="auto">
            Find exactly what you need from our comprehensive range of medical products
          </Typography>
        </Box>
            ...
            <Grid item xs={12} sm={6} md={3} key={index}>
              ...
              >
                <CardContent sx={{ p: 4, textAlign: 'center' }}>
                  ...
                  <Typography variant="h5" fontWeight="600" mb={1} color="#1a202c">
                    {category.name}
                  </Typography>
                  <Chip 
      ...
      <Box sx={{ bgcolor: '#f8fafc', py: 8 }}>
        <Container maxWidth="lg">
          ...
          <Box sx={{ minHeight: '200px', bgcolor: 'white', borderRadius: '16px', p: 4 }}>
            <Typography variant="body1" color="text.secondary" textAlign="center" pt={8}>
          ...
          {steps.map((step, index) => (
            <Grid item xs={12} sm={6} md={3} key={index}>
              <Box textAlign="center">
                ...
                <Typography variant="h5" fontWeight="600" mb={2} color="#1a202c">
                  {step.title}
                </Typography>
              ...
              <Grid item xs={12} sm={6} md={3} key={index}>
                ...
                >
                  <CardContent sx={{ p: 4, textAlign: 'center' }}>
                    ...
                    <Typography variant="h6" fontWeight="600" mb={2} color="#1a202c">
                      {feature.title}
                    </Typography>
                      ...
                      <Box>
                        ...
                        <Box display="flex" gap={0.5}>
                          {[...Array(review.rating)].map((_, i) => (
                            <StarIcon key={i} sx={{ color: '#ffc107', fontSize: '1rem' }} />
                          ))}
                        </Box>
                      </Box>
                    </Box>
